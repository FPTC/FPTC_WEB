(function() {
	var app = angular.module('registroControllers', ['angular.morris', 'ngMaterial', 'ngMessages', 'ngAnimate', 'ekosave-registro', 'firebase']).service('registrarCliente', function($http) {
